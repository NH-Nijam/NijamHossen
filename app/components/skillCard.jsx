...
const SkillCard = ({icons,name}) => {
    return (
        <div data-aos="fade-right" className='w-full  h-[100px] rounded hover:rounded-2xl shadow-md shadow-orange-600 hover:scale-105 duration-500 px-4 flex justify-between items-center'>
