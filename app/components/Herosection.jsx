    ...
    return (
        <div className='w-full h-screen flex justify-center items-center text-center'>
            <div className='lg:w-8/12 2xl:w-5/12 w-11/12 flex flex-col gap-4'>
                ...
                <h1 className='2xl:text-6xl lg:text-5xl md:text-4xl text-2xl text-bold'>Hi, l'm <span className='text-orange-600'>Nijam Hossen </span> </h1>
                ...
                <Link href='https://drive.google.com/file/d/1oCs5h72fffjdp2thyhFQxPgfJU2ZizMY/view?usp=sharing' target='blank'><button className='border px-5 mt-5 rounded-lg border-orange-600 hover:scale-110 duration-700  hover:shadow-md hover:shadow-orange-600 hover:text-orange-600 text-xl py-2'>Resume</button></Link>
            </div>
        </div>
    );
};
